FROM alpine
# FROM travix/base-alpine

# Set this environment variable to True to set timezone on container start.
ENV SET_CONTAINER_TIMEZONE False
# Default container timezone as found under the directory /usr/share/zoneinfo/.
ENV CONTAINER_TIMEZONE Europe/Amsterdam
# Version of ElastAlert to download
ENV ELASTALERT_VERSION v0.1.21
...
RUN apk update && \
    apk upgrade && \
    apk add ca-certificates openssl-dev openssl libffi-dev git python2 python2-dev py2-pip py2-yaml gcc musl-dev tzdata openntpd wget && \
